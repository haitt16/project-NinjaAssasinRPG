...
public class Player extends Entity {// Người chơi kế thừa nhân vật
    ...
    public void setDefaultValues() {
        ...
        projectile = new OBJ_Fireball(projectileGraphic);
    }
    ...
    public void getPlayerImage() {
        ...
        entityGraphic.up1 = setup("boy_up_1", entityGraphic.gp.tileSize, entityGraphic.gp.tileSize);
        entityGraphic.up2 = setup("boy_up_2", entityGraphic.gp.tileSize, entityGraphic.gp.tileSize);
        entityGraphic.down1 = setup("boy_down_1", entityGraphic.gp.tileSize, entityGraphic.gp.tileSize);
        entityGraphic.down2 = setup("boy_down_2", entityGraphic.gp.tileSize, entityGraphic.gp.tileSize);
        entityGraphic.left1 = setup("boy_left_1", entityGraphic.gp.tileSize, entityGraphic.gp.tileSize);
        entityGraphic.left2 = setup("boy_left_2", entityGraphic.gp.tileSize, entityGraphic.gp.tileSize);
        entityGraphic.right1 = setup("boy_right_1", entityGraphic.gp.tileSize, entityGraphic.gp.tileSize);
        entityGraphic.right2 = setup("boy_right_2", entityGraphic.gp.tileSize, entityGraphic.gp.tileSize);
    }

    public void getPlayerAttackImage() {
        entityGraphic.attackUp1 = setup("boy_attack_up_1", entityGraphic.gp.tileSize, entityGraphic.gp.tileSize * 2);
        entityGraphic.attackUp2 = setup("boy_attack_up_2", entityGraphic.gp.tileSize, entityGraphic.gp.tileSize * 2);
        entityGraphic.attackDown1 = setup("boy_attack_down_1", entityGraphic.gp.tileSize, entityGraphic.gp.tileSize * 2);
        entityGraphic.attackDown2 = setup("boy_attack_down_2", entityGraphic.gp.tileSize, entityGraphic.gp.tileSize * 2);
        entityGraphic.attackLeft1 = setup("boy_attack_left_1", entityGraphic.gp.tileSize * 2, entityGraphic.gp.tileSize);
        entityGraphic.attackLeft2 = setup("boy_attack_left_2", entityGraphic.gp.tileSize * 2, entityGraphic.gp.tileSize);
        entityGraphic.attackRight1 = setup("boy_attack_right_1", entityGraphic.gp.tileSize * 2, entityGraphic.gp.tileSize);
        entityGraphic.attackRight2 = setup("boy_attack_right_2", entityGraphic.gp.tileSize * 2, entityGraphic.gp.tileSize);
    }
    ...
    public void update() {
        ...
        if (attacking == true) {
            attacking();
        } else if (entityGraphic.keyH.upPressed == true || entityGraphic.keyH.downPressed == true || entityGraphic.keyH.leftPressed == true
            ...
            // ?
            if (entityGraphic.gp.keyH.shotKeyPressed == true && projectile.alive == false && entityGraphic.shotAvailableCounter == 20) {
